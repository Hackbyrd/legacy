...
/*-----------------------------------------------
  ...
  ------------------------------------------------*/
#if PY_VERSION_HEX >= 0x03000000
#  define SWIG_init    PyInit__sqr

#else
#  define SWIG_init    init_sqr

#endif
#define SWIG_name    "_sqr"
...
SWIGINTERN PyObject *_wrap_sqr(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  ...
  if (!SWIG_IsOK(ecode1)) {
    SWIG_exception_fail(SWIG_ArgError(ecode1), "in method '" "sqr" "', argument " "1"" of type '" "int""'");
  } 
  arg1 = (int)(val1);
  result = (int)sqr(arg1);
